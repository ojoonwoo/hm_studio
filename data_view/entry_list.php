...
?>
              <tr>
                ...
                <td><?php echo $buyer_info[$key]['mb_agree']?></td>
                <td><?php echo $buyer_info[$key]['utm_medium']?></td>
                <td><?php echo $buyer_info[$key]['utm_source']?></td>
                <td><?php echo $buyer_info[$key]['utm_campaign']?></td>
                <td><?php echo $buyer_info[$key]['utm_content']?></td>
