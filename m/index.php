	...
	<div class="wrap">
				...
				<div class="video-thumb-layer">
					<div class="wrapper">
						...
						<div class="button-wrap">
							<button type="button" class="btn-watch" onclick="click_tracking('국문/풀 영상 보기');viewVideo();gtag('event','영상재생',{'event_category':'메인영상재생','event_label':'메인영상재생'});">
								<p>Watch</p>
								<p>Full Version</p>
							</button>
		...
		<div class="section2-wrap">
			<div class="inner">
				...
				<div class="prize">
					<div class="_1">
						<h3 class="tt">1등<br>항공권 (5인/1인2매)</h3>
					...
					<div class="_1">
						<h3 class="tt">2등<br>아이패드 프로 (3명)</h3>
						<!-- <span>가고 싶은 현대 모터스튜디오로 향하는</span>
						<span>항공권 (1인 2매)</span> -->
						<!-- <div class="img-wrap">
							<img src="./images/prize_img_1.png" alt="">
					...
					<div class="_1">
						<h3 class="tt">3등<br>스타벅스 5만원 상품권 (30명)</h3>
					...
					<div class="_2">
						<h3 class="tt" style="line-height:1.2">참가상<br>고양 상설 전시 관람권<br />(100명/1인2매)</h3>
